...
![](static/images/logos/kaggle-logo-transparent.png)

> 欢迎任何人参与和完善：一个人可以走的很快，但是一群人却可以走的更远

* [Kaggle](https://www.kaggle.com) 是一个流行的数据科学竞赛平台。
* [Kaggle 入门操作指南](docs/QuickStart.md)，适合于学习过 [MachineLearning](https://github.com/apachecn/MachineLearning) 的小盆友
* 已被 Google 收购，请参阅[《谷歌收购 Kaggle 为什么会震动三界（AI、机器学习、数据科学界）》](https://www.leiphone.com/news/201703/ZjpnddCoUDr3Eh8c.html)
